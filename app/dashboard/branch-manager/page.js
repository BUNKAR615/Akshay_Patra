    ...
    return (
        <DashboardShell user={user} currentQuarter={currentQuarterName} title="Branch Manager Evaluation">
            ...
            {user && (
                <UserProfileCard
                    user={user}
                    extraInfo={{ label: "Scope", value: "All Departments", color: "text-[#00843D]" }}
                />
            )}
            {/* Department Selector for Global BM */}
            <div className="bg-[#E8F5E9] border border-[#A5D6A7] rounded-xl p-5 mb-8 shadow-sm">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-4">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <p className="text-[13px] text-[#2E7D32] font-bold uppercase tracking-wider mb-0.5">Global Branch Manager</p>
                            <p className="text-[20px] font-black text-[#1B5E20] leading-tight">Jaipur Branch</p>
                            {user?.designation && <p className="text-[14px] text-[#2E7D32] font-medium mt-1">{user.designation}</p>}
                        </div>
                    </div>
                </div>
            ...
            <div className="bg-white border border-[#E0E0E0] rounded-xl p-6 mb-8 shadow-sm">
                <div className="flex justify-between items-end mb-3">
                    <div>
                        ...
                        <span className="text-[15px] font-medium text-[#333333]">{progress.evaluated} of {progress.total} employees evaluated in this department</span>
                    </div>
                ...
                <div className="space-y-4">
                    ...
                    {shortlist.length === 0 ? (
                        <div className="bg-white border-2 border-[#E0E0E0] border-dashed rounded-2xl p-12 text-center shadow-sm">
                            ...
                            <p className="text-[#666666] text-[16px] max-w-md mx-auto">There are no employees waiting for your evaluation at this time in {currentDept?.name}. This may be because Stage 2 has not concluded yet.</p>
                        </div>
                    ) : (
