...
export const NAV = {
    ADMIN: [
        ...
        {
            // People & places. "Departments" (global dept + role-holders) and
            // "Org Structure" (per-branch org charts) sit together so their
            // relationship is obvious — they used to read as duplicate items.
            ...
            items: [
                ...
                { id: "hrcommittee", label: "Org Structure", icon: "star", href: "/dashboard/admin/global/hr-committee" },
            ],
        },
        {
            section: "Evaluation",
            items: [
                ...
                { id: "quarter", label: "Quarters", icon: "quarter", href: "/dashboard/admin?view=quarter" },
        ...
        },
        {
            section: "Reports",
            items: [
                { id: "reports", label: "Reports", icon: "reports", href: "/dashboard/admin?view=reports" },
            ],
        },
        {
            section: "System",
