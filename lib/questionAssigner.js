...
async function assignQuestionsToEmployees(tx, quarterId, selfQuestions, questionCount) {
    // Fetch all employees, with the data needed to resolve their effective
    // collar (live user value first, then their department's default).
    ...
    for (const emp of employees) {
        ...
        const empCollar = effectiveCollar(emp.collarType, emp.department?.collarType);
